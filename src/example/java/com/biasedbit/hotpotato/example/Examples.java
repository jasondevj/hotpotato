...
import com.biasedbit.hotpotato.session.DefaultHttpSession;
import com.biasedbit.hotpotato.session.handler.CookieStoringResponseHandler;
...
public class Examples {
    ...
    public static void example3() {
        ...
        HttpRequestFuture<String> future =
                client.execute("hotpotato.biasedbit.com", 80, request,
                               new BodyAsStringProcessor());
    ...
    public static void example5() {
        ...
        HttpRequestFuture<String> future = client
                .execute("hotpotato.biasedbit.com", 80, request, new BodyAsStringProcessor());
