 ...
 * <p/>
 * HTTP requests are dispatched from the {@link com.biasedbit.hotpotato.client.HttpClient} to the {@code HttpConnection}s
 ...
 * by calling {@link #isAvailable()} prior to {@link #execute(com.biasedbit.hotpotato.client.HttpRequestContext) execute()}.
 * <p/>
 * Example:
 * <pre class="code">
 ...
 * time, both will be able to {@linkplain #execute(com.biasedbit.hotpotato.client.HttpRequestContext) submit requests}, even though the implementation
 * may not accept both (and consequently fail the last one with {@link
 * com.biasedbit.hotpotato.request.HttpRequestFuture#EXECUTION_REJECTED}).
 * <p/>
 * Example:
 * <pre class="code">
