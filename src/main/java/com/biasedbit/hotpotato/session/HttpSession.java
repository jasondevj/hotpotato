 ...
 * <p/>
 * The {@code HttpSession} interface aims to simplify the usage of a {@link com.biasedbit.hotpotato.client.HttpClient} by
 * allowing requests to be passed as a full URL (e.g. http://hotpotato.biasedbit.com) rather than split by host, port
 * and URI (like {@link com.biasedbit.hotpotato.client.HttpClient} does.
 * <p/>
 ...
 * <p/>
 * The {@code HttpSession} relies on a underlying {@link com.biasedbit.hotpotato.client.HttpClient} to manage the request
 ...
 * {@link com.biasedbit.hotpotato.client.HttpClient} likes, as well as adding necessary headers when sending request in
 ...
 * {@link com.biasedbit.hotpotato.session.handler.CookieStoringResponseHandler} using the method
 ...
 *
 * @see com.biasedbit.hotpotato.session.handler.ResponseCodeHandler
 * @see com.biasedbit.hotpotato.client.HttpClient
 */
public interface HttpSession {
     ...
     *                                       {@link com.biasedbit.hotpotato.client.HttpClient}.
     */
