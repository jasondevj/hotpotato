 ...
 * com.biasedbit.hotpotato.client.HttpClient#execute(String, int, org.jboss.netty.handler.codec.http.HttpRequest,
 * com.biasedbit.hotpotato.response.HttpResponseProcessor) sumit a request execution} and receive an instance of
