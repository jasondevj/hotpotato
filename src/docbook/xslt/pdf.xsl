...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:param name="title.font.family">
    ...
    <xsl:message>
      <xsl:text>Setting 'title.font.family' param=</xsl:text>
      <xsl:copy-of select="$font" />
    </xsl:message>
    <xsl:copy-of select="$font" />
  </xsl:param>
  ...
  <xsl:param name="body.font.family">
    ...
    <xsl:message>
      <xsl:text>Setting 'body.font.family' param=</xsl:text>
      <xsl:copy-of select="$font" />
    </xsl:message>
    <xsl:copy-of select="$font" />
  </xsl:param>
  ...
  <xsl:param name="monospace.font.family">
    ...
    <xsl:message>
      <xsl:text>Setting 'monospace.font.family' param=</xsl:text>
      <xsl:copy-of select="$font" />
    </xsl:message>
    <xsl:copy-of select="$font" />
  </xsl:param>
  ...
  <xsl:param name="sans.font.family">
    ...
    <xsl:message>
      <xsl:text>Setting 'sans.font.family' param=</xsl:text>
      <xsl:copy-of select="$font" />
    </xsl:message>
    <xsl:copy-of select="$font" />
  </xsl:param>
  ...
  <xsl:param name="programlisting.font">
    ...
    <xsl:message>
      <xsl:text>Setting 'programlisting.font' param=</xsl:text>
      <xsl:copy-of select="$font" />
    </xsl:message>
    <xsl:copy-of select="$font" />
  </xsl:param>
